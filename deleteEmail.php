...
if ( $_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		//$data="SELECT count( * )FROM `electronic_address` WHERE  ssn='$ssn' and type='E'" ;
		...
		{
			deliver_response(400,"Email Deletion Aborted",NULL);
		}*/
	//	else
	//	{
			...
			if($data[0]>0 )
			{
				deliver_response(400,"Email cannot be deleted! Transactions exists for this email",NULL);
			}
			else
			{
			...
			else
			{
		        ...
		        deliver_response(200," Email  Deleted Successfully",$ssn);
