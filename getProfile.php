...
if ( $_SERVER['REQUEST_METHOD'] == 'GET')
	{
		...
		$query="SELECT name,password FROM user_account where ssn='$ssn'" ;
		...
		if ($result = mysqli_query($conn, $query)) 
			   {
                              ...
                              while ($row = mysqli_fetch_assoc($result)) 
	                      {
		                         ...
		                         deliver_response(200,"User Name and Password  " , $row["name"] , $row["password"]);
                          }
                }
		...
		{
			deliver_response(400,"User Not found ",NULL,NULL);
